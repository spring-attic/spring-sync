...
public class CopyOperationTest extends TestCase {
	...
	public void testCopyBooleanPropertyValue() throws Exception {
		// initial Todo list
	...
	public void testCopyStringPropertyValue() throws Exception {
		// initial Todo list
		List<Todo> todos = new ArrayList<Todo>();
		todos.add(new Todo(1L, "A", true));
		todos.add(new Todo(2L, "B", false));
	...
	public void testCopyBooleanPropertyValueIntoStringProperty() throws Exception {
		// initial Todo list
		List<Todo> todos = new ArrayList<Todo>();
		todos.add(new Todo(1L, "A", true));
		todos.add(new Todo(2L, "B", false));
	...
	public void testCopyListElementToBeginningOfList() throws Exception {
		// initial Todo list
		List<Todo> todos = new ArrayList<Todo>();
		...
		assertEquals(2L, todos.get(0).getId().longValue()); // NOTE: This could be
															// problematic if you try to
															// save it to a DB because
															// there'll be duplicate IDs
		assertEquals("B", todos.get(0).getDescription());
		assertTrue(todos.get(0).isComplete());
	}

	public void testCopyListElementToMiddleOfList() throws Exception {
		// initial Todo list
		List<Todo> todos = new ArrayList<Todo>();
		todos.add(new Todo(1L, "A", true));
		todos.add(new Todo(2L, "B", false));
		...
		assertEquals(4, todos.size());
		assertEquals(1L, todos.get(2).getId().longValue()); // NOTE: This could be
															// problematic if you try to
															// save it to a DB because
															// there'll be duplicate IDs
	...
	public void testCopyListElementToEndOfList_usingIndex() throws Exception {
		// initial Todo list
		List<Todo> todos = new ArrayList<Todo>();
		todos.add(new Todo(1L, "A", true));
		todos.add(new Todo(2L, "B", false));
		...
		assertEquals(4, todos.size());
		assertEquals(1L, todos.get(3).getId().longValue()); // NOTE: This could be
															// problematic if you try to
															// save it to a DB because
															// there'll be duplicate IDs
	...
	public void testCopyListElementToEndOfList_usingTilde() throws Exception {
		...
		assertEquals(4, todos.size());
		assertEquals(new Todo(1L, "A", true), todos.get(3)); // NOTE: This could be
																// problematic if you try
																// to save it to a DB
																// because there'll be
																// duplicate IDs
	}
	...
	public void testCopyListElementFromEndOfList_usingTilde() throws Exception {
		...
		assertEquals(4, todos.size());
		assertEquals(new Todo(3L, "C", false), todos.get(0)); // NOTE: This could be
																// problematic if you try
																// to save it to a DB
																// because there'll be
																// duplicate IDs
