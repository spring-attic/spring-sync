...
public class JsonPatchTest extends TestCase {
	...
	public void testManySuccessfulOperations() throws Exception {
		// initial Todo list
	...
	public void testFailureAtBeginning() throws Exception {
		// initial Todo list
		List<Todo> todos = new ArrayList<Todo>();
		todos.add(new Todo(1L, "A", true));
		todos.add(new Todo(2L, "B", false));
	...
	public void testFailureInMiddle() throws Exception {
		// initial Todo list
		List<Todo> todos = new ArrayList<Todo>();
		todos.add(new Todo(1L, "A", true));
		todos.add(new Todo(2L, "B", false));
	...
	private Patch readJsonPatch(String jsonPatchFile) throws IOException,
